  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-900 text-gray-100">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              id="sort_order"
              className="border rounded-lg p-3 bg-gray-800 text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              <option value="regularPrice_desc" className="text-gray-200">
                Price high to low
              </option>
              <option value="regularPrice_asc" className="text-gray-200">
                Price low to high
              </option>
              <option value="createdAt_desc" className="text-gray-200">
                Latest
              </option>
              <option value="createdAt_asc" className="text-gray-200">
                Oldest
              </option>
            </select>
          </div>
          <button className="bg-blue-700 text-white rounded-lg p-3 hover:opacity-95">
            Search
          </button>
        </form>
      </div>
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-semibold p-3 border-b text-gray-300 mt-5 border-gray-700">
          Listing Results:
        </h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-6 p-7">
          ...
          {showMore && (
            <button
              className="text-green-400 hover:underline p-7 w-full text-left"
