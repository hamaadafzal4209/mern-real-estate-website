        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} action="" className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <input type="text" placeholder='Address' className='border p-3 rounded-lg' id='address' maxLength={60} minLength={10} required onChange={handleChange} value={formData.address} />
